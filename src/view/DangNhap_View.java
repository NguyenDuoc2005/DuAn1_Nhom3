...
public class DangNhap_View extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rdoAn_Hien_PassWord = new javax.swing.JRadioButton();
        lblTaoTKMoi = new javax.swing.JLabel();
        ...
        rdoAn_Hien_PassWord.setBackground(new java.awt.Color(153, 204, 255));
        rdoAn_Hien_PassWord.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                rdoAn_Hien_PassWordMouseClicked(evt);
            }
        });
        rdoAn_Hien_PassWord.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                rdoAn_Hien_PassWordKeyReleased(evt);
            }
        });
        jPanel4.add(rdoAn_Hien_PassWord, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 20, -1));

        lblTaoTKMoi.setFont(new java.awt.Font("Segoe UI", 2, 12)); // NOI18N
        lblTaoTKMoi.setForeground(new java.awt.Color(255, 255, 255));
        lblTaoTKMoi.setText("Create new account ?");
        lblTaoTKMoi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblTaoTKMoiMouseClicked(evt);
            }
        });
        jPanel4.add(lblTaoTKMoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 120, -1));
    ...
    private void rdoAn_Hien_PassWordKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_rdoAn_Hien_PassWordKeyReleased
        // TODO add your handling code here:

    }//GEN-LAST:event_rdoAn_Hien_PassWordKeyReleased

    private void rdoAn_Hien_PassWordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rdoAn_Hien_PassWordMouseClicked
       if (rdoAn_Hien_PassWord.isSelected()) {
         txtPassWord.setEchoChar((char) 0);
        } else {
           txtPassWord.setEchoChar('\u2022');  
        }
    }//GEN-LAST:event_rdoAn_Hien_PassWordMouseClicked

    private void lblTaoTKMoiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblTaoTKMoiMouseClicked
            TaoTaiKhoan_View taoTK = new TaoTaiKhoan_View(); 
            taoTK.setVisible(true);
            dispose();
    }//GEN-LAST:event_lblTaoTKMoiMouseClicked
    ...
    private javax.swing.JLabel lblTaoTKMoi;
    private javax.swing.JRadioButton rdoAn_Hien_PassWord;
